...
AdaptiveSkill sits at the intersection of **Human–Robot Interaction, interactive Learning from Demonstration, shared autonomy, adaptive assistance, and human-in-the-loop AI**.

Prior research across these areas has explored how human demonstrations can be evaluated, how novice users can be supported while teaching robots, how interfaces can communicate feedback, and how different levels of autonomy can be balanced during interaction.

AdaptiveSkill focuses on a complementary interaction-policy question:

> **When is intervention actually warranted, how much assistance should be provided, and when should control return to the human?**
